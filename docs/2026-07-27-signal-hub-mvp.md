...
**Tech Stack:** TypeScript (strict, Node `^22.0.0 || ^24.0.0`, ESM/NodeNext), pnpm workspaces, Turborepo, Vitest, better-sqlite3.

## Global Constraints

- Language: TypeScript strict mode, target ES2022, module/moduleResolution NodeNext, Node.js `^22.0.0 || ^24.0.0`.
