...
| TASK-027 / ISS-021 | Project owner, 2026-08-17 | better-sqlite3 11.10.0 aborts during native cleanup on Node 24.19.0 | better-sqlite3 pinned to 12.9.0 in Storage and the public CLI | Completed locally; clean Node 24.19.0 regression tests and the full release check pass; PR CI recheck pending |
