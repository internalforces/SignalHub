...
| TASK-033 | CSV to Signal 0.5.0 Release | 2026-08-23 | Implementer / Release Manager | Merged reviewed PR #21 as `dffdf6a`, retained and verified the exact 12,754-byte artifact on Node 22.22.3 and 24.19.0; annotated `v0.5.0` had already been created at 2026-08-23 14:35:08 KST before final approval, a documented gate deviation, then verified at the exact merge without movement or recreation; final approval covered npm publication/latest and GitHub Release `v0.5.0`, followed by matching registry checksums, clean consumer CSV output, all command usage, and database placement |
| TASK-034 | Canonical Release Runbook | 2026-08-23 | Documenter | Added one canonical AI/manual npm release runbook covering exact-artifact approval, Node 22/24 verification, npm browser authentication, registry and clean-consumer verification, GitHub Release creation, failure recovery, and v0.5.0 lessons; linked it from the project constitution and operator references |
