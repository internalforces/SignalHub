...
| TASK-028 | Align Public Node Engine Contract | 2026-08-17 | Implementer | Addressed PR #16 review by bounding root and CLI engines to the tested Node 20/22/24 releases supported by better-sqlite3 12.9.0; full release check passes and PR CI recheck is pending |
